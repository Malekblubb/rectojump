...
namespace rj
{
	...
	public:
		...
		bool is_key_valid(key k) const noexcept { return k != key::Unknown; }
	...
	namespace inp
	{
		...
		inline auto& i() { return input<game_window>::get(); }
